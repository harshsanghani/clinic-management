<template>
    <div class="card">
        <div class="card-header">
            ...
            <div class="actions">
                <a :href="base_url+'portal/doctor/setup'" class="btn btn-success waves-effect btn-lg">New Admin</a>
            </div>
        </div>
            ...
            <div class="table-responsive">
                <v-server-table  ref="table" columnsClasses="table table-bordered invoice_table"
                    ...
                    <div slot="action" slot-scope="{ row }">
                        <a :href="base_url+'portal/doctor/setup/'+row.id" class="btn btn-primary">Edit</a>
                        <a :href="base_url+'portal/doctor/delete/'+row.id" class="btn btn-danger">Delete</a>
                    </div>
                </v-server-table>
            </div>
        </div>
...
<script>
   ...
   export default {
       ...
       data(){
            ...
            return {
                base_url        : base_url,
                report_url      : portal_url+'/doctor/list',
