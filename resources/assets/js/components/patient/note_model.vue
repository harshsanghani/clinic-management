            ...
            <div class="row">
                <div class="col-md-6">
                   <div class="form-group">
                        ...
                        <datepicker name="appointment_date"  format="MM/dd/yyyy" input-class="form-control date-mask" :value="appointment_date"></datepicker>
               ...
               <div class="col-md-6">
                   <div class="form-group">
                       ...
                       <select id="appointment_time" name="appointment_time" class="form-control"  v-model="appointment_time" >
                            <option v-for="ts in time_slots" :value="ts" >{{ ts }} </option>
                       </select>
            ...
            <div class="tab-container">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active show" id="home-2" role="tabpanel" aria-expanded="true">
                        <div class="col-sm-12">
                            <vue-editor id="notes"  v-model="note_data"  name="notes">{{notes.notes}}</vue-editor>
                            <span v-if="allErrors.notes" :class="['help-inline']">{{ allErrors.notes[0] }}</span>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="profile-2" role="tabpanel" aria-expanded="false">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Diet</label>
                                <textarea class="form-control"  name="diet" id="diet"  rows="5" placeholder="">{{notes.diet}}</textarea>
                                <span v-if="allErrors.diet" :class="['help-inline']">{{ allErrors.diet[0] }}</span>
                            </div>
                            <div class="form-group">
                                <label>Diagnosis</label>
                                <textarea class="form-control" name="diagnosis" id="diagnosis"  rows="5" placeholder="">{{notes.diagnosis}}</textarea>
                                <span v-if="allErrors.diagnosis" :class="['help-inline']">{{ allErrors.diagnosis[0] }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="messages-2" role="tabpanel">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" name="medicines" id="medicines" placeholder="">{{notes.medicines}}</textarea>
                                <span v-if="allErrors.medicines" :class="['help-inline']">{{ allErrors.medicines[0] }}</span>
                            </div>
                        </div>
                    </div>
                </div>
