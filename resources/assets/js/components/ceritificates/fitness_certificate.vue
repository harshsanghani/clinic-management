<template>
    <form :action="base_url + 'portal/certificate/commit/'+report_id" method="post" class="fitness_form">
        ...
        <div class="card">
            ...
            <div class="card-block">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>Fit to resume Date (DD-MM-YYYY)</label>
                            <input type="text" class="form-control date-mask" v-model="cert_detail.fit_resume_date" name="certificate[fit_resume_date]" placeholder="Select date" value="">
                        </div>
                    </div>
                </div>
            </div>
