<template>
    <form :action="base_url + 'portal/certificate/commit/'+report_id" method="post" class="receipt_form">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" v-model="cert_detail.relation" name="certificate[relation]">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" v-model="cert_detail.relative_name" class="form-control" name="certificate[relative_name]" value="" >
                        </div>
                    </div>
                </div>
                <div class="row">
