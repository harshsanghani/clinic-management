...
<!--            <li class="{{ (request()->is('portal/listpatient')) ? 'navigation__active' : '' }}">
            ...
            <li class="{{ (request()->is('portal/master*') || request()->is('portal/doctor*') || request()->is('portal/receptionist*') ) ? 'navigation__sub navigation__sub--toggled' : 'navigation__sub' }}">
                <a href="#"><i class="zmdi zmdi-view-week"></i>Manage Users</a>
                <ul style="{{ (request()->is('portal/master*') || request()->is('portal/doctor*') || request()->is('portal/receptionist*') ) ? 'display:block' : 'display:none' }}">
                    <li class="{{ (request()->is('portal/master*')) ? 'navigation__active' : '' }}">
                        <a href="{{asset('portal/master')}}">Master Admin</a>
                    </li>
                    <li class="{{ (request()->is('portal/doctor*')) ? 'navigation__active' : '' }}">
                        <a href="{{asset('portal/doctor')}}">Doctors</a>
                    </li>
                    <li class="{{ (request()->is('portal/receptionist*')) ? 'navigation__active' : '' }}">
                        <a href="{{asset('portal/receptionist')}}">Receptionists</a>
                    </li>
                </ul>
            </li>
        </ul>
