...
<div class="content__inner"> 
    <patients_report :report_type="{{ $report_type }}" :report_name="{{ $report_name }}" :patient_options="{{ $patient_options }}" :id="{{ $id }}" :report_detail="{{ $report_detail }}" :certificate_detail="{{ $certificate_detail }}"></patients_report>
</div>
@stop
@section('js')
    ...
    <script src="{{asset('assets/portal-side/js/modules/patient_report.js') }}"></script>
@stop