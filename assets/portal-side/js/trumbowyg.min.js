...
function(e, t, n, a) {
    ...
    var o = function(o, r) {
        ...
        i.$c = a(o),
        r = r || {},
        null != r.lang || null != a.trumbowyg.langs[r.lang] ? i.lang = a.extend(!0, {}, a.trumbowyg.langs.en, a.trumbowyg.langs[r.lang]) : i.lang = a.trumbowyg.langs.en,
        i.hideButtonTexts = null != a.trumbowyg.hideButtonTexts ? a.trumbowyg.hideButtonTexts : r.hideButtonTexts;
        var l = null != a.trumbowyg.svgPath ? a.trumbowyg.svgPath : r.svgPath;
        if (i.hasSvg = l !== !1,
        i.svgPath = i.doc.querySelector("base") ? t.location.href.split("#")[0] : "",
        0 === a("#" + s, i.doc).length && l !== !1) {
            if (null == l)
                try {
                    throw new Error
                } catch (d) {
                    ...
                    for (var u in c)
                        if (c[u].match(/http[s]?:\/\//)) {
                            l = c[Number(u)].match(/((http[s]?:\/\/.+\/)([^\/]+\.js))(\?.*)?:/)[1].split("/"),
                            l.pop(),
                            l.pop(),
                            l = l.join("/") + "/img/icons.svg";
                            break
                        }
                }
            var g = i.doc.createElement("div");
            g.id = s,
            i.doc.body.insertBefore(g, i.doc.body.childNodes[0]),
            a.ajax({
                async: !0,
                type: "GET",
                ...
                complete: null,
                success: function(e) {
                    g.innerHTML = (new XMLSerializer).serializeToString(e.documentElement)
                }
            })
        }
        var f = i.lang.header
        ...
        i.o = a.extend(!0, {}, {
            ...
            imgDblClickHandler: function() {
                var e = a(this)
                  , t = e.attr("src")
                  , n = "(Base64)";
                return 0 === t.indexOf("data:image") && (t = n),
                i.openModalInsert(i.lang.insertImage, {
                    url: {
                        label: "URL",
                        value: t,
                        required: !0
        ...
        i.disabled = i.o.disabled || "TEXTAREA" === o.nodeName && o.disabled,
        r.btns ? i.o.btns = r.btns : i.o.semantic || (i.o.btns[4] = "btnGrp-design"),
        ...
        i.isIE = -1 !== e.userAgent.indexOf("MSIE") || -1 !== e.appVersion.indexOf("Trident/"),
        i.init()
    };
    o.prototype = {
        init: function() {
            var e = this;
            e.height = e.$ta.height(),
            e.initPlugins();
            try {
        ...
        buildEditor: function() {
            ...
            e.isTextarea ? (o = e.$ta.val(),
            e.$ed = a("<div/>"),
            e.$box.insertAfter(e.$ta).append(e.$ed, e.$ta)) : (e.$ed = e.$ta,
            o = e.$ed.html(),
            e.$ta = a("<textarea/>", {
                name: e.$ta.attr("id"),
                height: e.height
            ...
            e.$ed.on("dblclick", "img", e.o.imgDblClickHandler).on("keydown", function(t) {
                ...
                if ("compositionend" === t.type)
                    ...
                    return;
                var n = t.which;
                n >= 37 && 40 >= n || (!t.ctrlKey || 89 !== n && 90 !== n ? i || 17 === n ? "undefined" == typeof t.which && e.semanticCode(!1, !1, !0) : (e.semanticCode(!1, 13 === n),
                e.$c.trigger("tbwchange")) : e.$c.trigger("tbwchange"),
                setTimeout(function() {
                    i = !1
                }, 200))
                ...
                "blur" === t.type && a("." + n + "active-button", e.$btnPane).removeClass(n + "active-button " + n + "active")
            }).on("cut", function() {
                setTimeout(function() {
                    e.semanticCode(!1, !0),
            ...
            e.$box.on("keydown", function(t) {
                return 27 === t.which && 1 === a("." + n + "modal-box", e.$box).length ? (e.closeModal(),
                !1) : void 0
            })
        },
        buildBtnPane: function() {
            ...
            a.each(e.o.btns, function(o, r) {
                ...
                a.each(r, function(t, n) {
                    try {
                        var a;
                        e.isSupportedBtn(n) && (a = e.buildBtn(n)),
                        l.append(a)
                    } catch (o) {}
                }),
                n.append(l)
        ...
        buildBtn: function(e) {
            var t = this
              ...
              , l = a("<button/>", {
                ...
                tabindex: -1,
                mousedown: function() {
                    return (!r || a("." + e + "-" + n + "dropdown", t.$box).is(":hidden")) && a("body", t.doc).trigger("mousedown"),
                    !t.$btnPane.hasClass(n + "disable") || a(this).hasClass(n + "active") || a(this).hasClass(n + "not-disable") ? (t.execCmd((r ? "dropdown" : !1) || o.fn || e, o.param || e, o.forceCss || !1),
                    !1) : !1
                }
            });
            if (r) {
            ...
            return r || (t.tagToButton[(o.tag || e).toLowerCase()] = e),
            l
        },
        buildSubBtn: function(e) {
            ...
            a("<button/>", {
                ...
                style: o.style || null,
                mousedown: function() {
                    return a("body", t.doc).trigger("mousedown"),
                    t.execCmd(o.fn || e, o.param || e, o.forceCss || !1),
                    !1
                }
            })
        },
        ...
        hideOverlay: function() {
            var e = this;
            e.$overlay.fadeOut(50),
            e.$box.removeClass(e.o.prefix + "box-blur")
        },
        fixedBtnPaneEvents: function() {
            var e = this
              , n = e.o.fixedFullWidth
              , o = e.$box;
            e.o.fixedBtnPane && (e.isFixed = !1,
            a(t).on("scroll." + e.eventNamespace + " resize." + e.eventNamespace, function() {
                if (o) {
                    e.syncCode();
                    var r = a(t).scrollTop()
                      , i = o.offset().top + 1
                      , s = e.$btnPane
                      , l = s.outerHeight() - 2;
                    r - i > 0 && r - i - e.height < 0 ? (e.isFixed || (e.isFixed = !0,
                    s.css({
                        position: "fixed",
                        top: 0,
                        left: n ? "0" : "auto",
        ...
        destroy: function() {
            ...
            e.isTextarea ? e.$box.after(e.$ta.css({
                ...
                height: o
            }).removeClass(n + "editor").removeAttr("contenteditable").html(e.html()).show()),
            ...
            a(t).off("scroll." + e.eventNamespace + " resize." + e.eventNamespace)
        },
        empty: function() {
            this.$ta.val(""),
            this.syncCode(!0)
        ...
        toggle: function() {
            ...
            setTimeout(function() {
                ...
                a("." + t + "viewHTML-button", e.$btnPane).toggleClass(t + "active"),
                e.$box.hasClass(t + "editor-visible") ? e.$ta.attr("tabindex", -1) : e.$ta.removeAttr("tabindex")
            }, 0)
        },
        dropdown: function(e) {
            var n = this
            ...
            l) {
                ...
                a(t).trigger("scroll"),
                a("body", o).on("mousedown." + n.eventNamespace, function(e) {
                    i.is(e.target) || (a("." + r + "dropdown", o).hide(),
                    a("." + r + "active", o).removeClass(r + "active"),
                    a("body", o).off("mousedown." + n.eventNamespace))
                })
            }
        },
        html: function(e) {
            var t = this;
            return null != e ? (t.$ta.val(e),
            t.syncCode(!0),
            t) : t.$ta.val()
        },
        ...
        syncCode: function(e) {
            var t = this;
            !e && t.$ed.is(":visible") ? t.syncTextarea() : t.$ed.html(t.$ta.val()),
        ...
        semanticCode: function(e, t, n) {
            ...
            if (o.saveRange(),
            o.syncCode(e),
            a(o.o.tagsToRemove.join(","), o.$ed).remove(),
            o.o.semantic) {
                if (o.semanticTag("b", "strong"),
                o.semanticTag("i", "em"),
                t) {
                    ...
                    s(o.$ed.children(r).first()),
                    o.semanticTag("div", "p", !0),
                    o.$ed.find("p").filter(function() {
        ...
        semanticTag: function(e, t, n) {
            a(e, this.$ed).each(function() {
                var e = a(this);
                e.wrap("<" + t + "/>"),
                n && a.each(e.prop("attributes"), function() {
        ...
        createLink: function() {
            ...
            o.openModalInsert(o.lang.createLink, {
                ...
                return e.title.length > 0 && t.attr("title", e.title),
                e.target.length > 0 && t.attr("target", e.target),
                o.range.deleteContents(),
                o.range.insertNode(t[0]),
                !0
            })
        },
        unlink: function() {
        ...
        insertImage: function() {
            var e = this;
            e.saveRange(),
            e.openModalInsert(e.lang.insertImage, {
                url: {
                    label: "URL",
                    required: !0
                },
                ...
                return e.execCmd("insertImage", t.url),
                a('img[src="' + t.url + '"]:not([alt])', e.$box).attr("alt", t.alt),
                !0
            })
        },
        fullscreen: function() {
        ...
        execCmd: function(e, t, n, a) {
            ...
            try {
                ...
                try {
                    ...
                    "insertHorizontalRule" === e ? t = void 0 : "formatBlock" === e && o.isIE && (t = "<" + t + ">"),
                    o.doc.execCommand(e, !1, t),
                    o.syncCode(),
                    o.semanticCode(!1, !0)
                }
                "dropdown" !== e && (o.updateButtonPaneStatus(),
        ...
        openModal: function(e, n) {
            var o = this
              , r = o.o.prefix;
            if (a("." + r + "modal-box", o.$box).length > 0)
                return !1;
            o.saveRange(),
            o.showOverlay(),
            o.$btnPane.addClass(r + "disable");
            var i = a("<div/>", {
            ...
            i.height(l.outerHeight() + 10),
            a("input:first", l).focus(),
            o.buildModalBtn("submit", l),
            o.buildModalBtn("reset", l),
            a(t).trigger("scroll"),
            i
        },
        ...
        closeModal: function() {
            var e = this
              , t = e.o.prefix;
            e.$btnPane.removeClass(t + "disable"),
            e.$overlay.off();
        ...
        openModalInsert: function(e, t, n) {
            ...
            return a.each(t, function(e, t) {
                ...
                s += '<label><input type="' + (t.type || "text") + '" name="' + a + '" value="' + (t.value || "").replace(/"/g, "&quot;") + '"' + l + '><span class="' + r + 'input-infos"><span>' + (n ? i[n] ? i[n] : n : i[e] ? i[e] : e) + "</span></span></label>"
            }),
            o.openModal(e, s).on(l, function() {
                ...
                a.each(t, function(t, n) {
                    var s = a('input[name="' + t + '"]', e)
                      , l = s.attr("type");
                    "checkbox" === l.toLowerCase() ? i[t] = s.is(":checked") : i[t] = a.trim(s.val()),
                    n.required && "" === i[t] ? (r = !1,
                    o.addErrorOnModalField(s, o.lang.required)) : n.pattern && !n.pattern.test(i[t]) && (r = !1,
                    o.addErrorOnModalField(s, n.patternError))
                }),
                r && (o.restoreRange(),
                n(i, t) && (o.syncCode(),
                o.$c.trigger("tbwchange"),
            ...
            if (a) {
                if (n && n.start !== n.end) {
                    ...
                    for (e = t.doc.createRange(); !d && (r = s.pop()); )
                        if (3 === r.nodeType) {
                            var c = i + r.length;
                            !l && n.start >= i && n.start <= c && (e.setStart(r, n.start - i),
                            l = !0),
                            l && n.end >= i && n.end <= c && (e.setEnd(r, n.end - i),
                            d = !0),
                            i = c
                        } else
        ...
        updateButtonPaneStatus: function() {
            ...
            a("." + t + "active-button", e.$btnPane).removeClass(o),
        ...
        getTagsRecursive: function(e, t) {
            var n = this;
            if (t = t || (e && e.tagName ? [e.tagName] : []),
            !e || !e.parentNode)
                return t;
            e = e.parentNode;
            var o = e.tagName;
            return "DIV" === o ? t : ("P" === o && "" !== e.style.textAlign && t.push(e.style.textAlign),
            a.each(n.tagHandlers, function(a, o) {
                t = t.concat(o(e, n))
            }),
            t.push(o),
            n.getTagsRecursive(e, t))
        },
        initPlugins: function() {
            var e = this;
            e.loadedPlugins = [],
            a.each(a.trumbowyg.plugins, function(t, n) {
                (!n.shouldInit || n.shouldInit(e)) && (n.init(e),
