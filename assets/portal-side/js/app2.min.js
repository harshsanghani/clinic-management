...
$("#dropzone-upload")[0] && (Dropzone.autoDiscover = !1),
    $(document).ready(function() {
        ...
        if ($(".textarea-autosize")[0] && autosize($(".textarea-autosize")),
        ...
        if ($(".input-slider")[0])
            for (var g = document.getElementsByClassName("input-slider"), h = 0; h < g.length; h++)
        ...
        $('[data-toggle="popover"]')[0] && $('[data-toggle="popover"]').popover(),
            ...
            $(".widget-calendar__year").html(i),
            $(".widget-calendar__day").html(j)
        }
        if ($(".notes__body")[0]) {
            var k;
            $(".notes__body").each(function(a, b) {
                k = $(this).prev().is(".notes__title") ? 4 : 6,
                $clamp(b, {
                    clamp: k
                })
            })
